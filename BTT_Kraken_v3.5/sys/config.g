...
; Axes
M584 X0 Y1 Z2 A4 B5 ; set axis mapping
M350 X16 Y16 Z16 A16 B16 I1 ; configure microstepping with interpolation

M569.9 P0 R0.022 S2.0 ; driver 0 has a 0.022 Ohm sense resistor and current limit of 2.0A
M569.9 P1 R0.022 S2.0 ; driver 1 has a 0.022 Ohm sense resistor and current limit of 2.0A
M569.9 P2 R0.022 S0.8 ; driver 2 has a 0.022 Ohm sense resistor and current limit of 0.8A
M569.9 P4 R0.075 S0.5 ; driver 4 has a 0.075 Ohm sense resistor and current limit of 0.5A
M569.9 P5 R0.075 S0.5 ; driver 5 has a 0.075 Ohm sense resistor and current limit of 0.5A
